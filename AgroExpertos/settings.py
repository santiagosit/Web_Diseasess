"""
Django settings for AgroExpertos project.
...
SECRET_KEY = 'django-insecure-g6uj2ko@yk6oz*7)@!g%!*fy@-q4e63++d*$d=7-pngk@sy&^e'
...
ROOT_URLCONF = 'AgroExpertos.urls'
...
WSGI_APPLICATION = 'AgroExpertos.wsgi.application'
